<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,100:58A6FF&height=220&section=header&text=Sicheng&fontSize=80&fontColor=ffffff&fontAlignY=35&desc=C%2B%2B%20Backend%20Developer%20%7C%20AI%20Agent%20Explorer&descSize=18&descAlignY=55&descColor=99d1ce&animation=fadeIn" />
</p>

<h1 align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&pause=1000&color=58A6FF&center=true&vCenter=true&random=false&width=600&lines=%F0%9F%91%8B+Hey%2C+I'm+Sicheng;C%2B%2B+Backend+Developer;AI+Agent+Explorer" alt="Typing SVG" />
</h1>
...
```json
{
  ...
  "education": "西安科技大学 · 通信工程",
  "experience": "游戏服务器开发实习（Redis-MongoDB 分层存储 / CGO 中间件）",
  "focus": ["C++ 后端开发", "AI Agent / LLM 应用"],
  "learning": ["分布式系统", "LLM 推理部署（vLLM / TensorRT-LLM）"],
  "mail": "sichengxia66@gmail.com",
...
<p align="center">
  ...
  <a href="mailto:sichengxia66@gmail.com"><img src="https://img.shields.io/badge/Gmail-EA4335?style=flat&logo=gmail&logoColor=white" /></a>
</p>
